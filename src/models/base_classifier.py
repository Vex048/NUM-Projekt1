...
class BaseClassifier(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        if batch_idx == 0:
            ...
            images = torch.clamp(images, 0, 1) # Ucinamy żeby W&B się nie buntowało na wartości rzędu 1.0001
            ...
            if isinstance(self.logger, pl.loggers.WandbLogger):
                self.logger.experiment.log({"val/predictions": wandb_images, "global_step": self.global_step})
